      ...
      function (error2, topic) {
        ...
        var html = template.HTML(
          ...
          `       
                <p id="ctrl">
                    <p><a href="/topic/create">Create content</a></p>
                    <a href="/topic/update/${_id}">Update Content</a>
                </p>                
      ...
      var html = template.HTML(
        ...
        `
                        <form action="/topic/create_process" method="post">
                            ...
                            <p>
                                <textarea name="144" placeholder="description"></textarea>
                            </p>
                            <p>
...
exports.update = function (req, res, _id) {
  db.query(`SELECT * FROM topic`, function (error, topics) {
    ...
    db.query(`SELECT * FROM topic WHERE id=?`, [_id], function (error2, topic) {
      if (error2) {
        throw error2
      }
